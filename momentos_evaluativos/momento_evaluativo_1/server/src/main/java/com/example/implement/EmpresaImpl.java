...
public class EmpresaImpl extends UnicastRemoteObject  implements IEmpresa {
    ...
    private double[][] matrizSalarios; // Filas: empleados, Columnas: meses
    ...
    // Llena la matriz de salarios con valores aleatorios entre 1000 y 5000
    @Override
    ...
    // Calcula el total pagado cada mes a todos los empleados
    @Override
    ...
    // Calcula el promedio mensual de los pagos a todos los empleados
    @Override
